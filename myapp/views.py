...
def user_query_add(request):
    if request.method == 'POST':
        ...
        context = {'msg': 'Player avg transfer value estimated (euros)','estimate':estimate,'msg2': 'Player overall performance value estimated','overall':round(overall, 3)}
